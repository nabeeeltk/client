...
export const createMember = (formData) => api.post('/members', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
export const updateMember = (id, formData) => api.put(`/members/${id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
export const deleteMember = (id) => api.delete(`/members/${id}`)
export const uploadMemberPhoto = (id, formData) => api.post(`/members/${id}/photo`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })

// Programmes
export const getProgrammes = () => api.get('/programmes')
export const getUnitProgrammes = (unitId) => api.get(`/programmes/unit/${unitId}`)
export const createProgramme = (formData) => api.post('/programmes', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
export const updateProgramme = (id, formData) => api.put(`/programmes/${id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
...
// Gallery
export const getGallery = (programmeId) => api.get('/gallery', { params: programmeId ? { programme_id: programmeId } : {} })
...
export const getUnitBloodMembers = (unitId, bloodGroup) => api.get(`/blood/unit/${unitId}`, { params: bloodGroup ? { blood_group: bloodGroup } : {} })
...
export const createUpload = (formData) => api.post('/uploads', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
